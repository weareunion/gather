...
<?php require_once __DIR__ . "/../elements/container/container_start.php"; ?>
<meta charset="utf-8">
        ...
        <div class="modal-content bg-transparent border-0 shadow-none">
            <div class="">
                <div class="justify-content-center">
                    <div class="text-center m-1 animate__animated animate__fadeIn" style="display: flex;flex-direction: column;align-items: center; animation-duration: .5s;">
                        <div class="spinner">
