                        ...
                        echo <<<EOT
                                <div class="card text-danger  shadow-none bg-info text-left btn-hover">
                                                        <div class="card-body text-center ">
                                                            <h4 class="card-title text-white mb-0">Looks a Little Empty 😔</h4>
...
EOT;
                    ...
                    <button type="button" class="btn btn-link text-warning btn-lg btn-block mt-1 font-size-md"><i class="fe-close mr-2"></i>Cancel</button>
