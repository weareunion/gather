        ...
        <div class="row h-100 justify-content-center align-items-center "style="z-index: -1;">
            <div class="col-12">
                <div class="">
                    ...
                    <p class="text-center pt-0 text-white-50 mt-0 mb-5 animate__animated animate__fadeInDown" style="animation-delay: 0.1s">Your one card for all your Gather needs. <a class="text-primary ">Learn More</a></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container" style="z-index: 1;">
    <div class="d-flex justify-content-center align-items-center " style="z-index: 1; height: 75vh;">
        ...
        <div class="card  bg-faded-dark border-0 shadow-none justify-content-center animate__animated animate__fadeIn animate__fadeInUp" style="width: 400px; height: 230px; animation-delay: .2s">
            <div class="card-body d-block">
                <div>
                    ...
                    <h4 class="float-right text-white animate__animated animate__fadeInUp" style="animation-delay: 0.2s"><p class="font-size-sm float-left">$</p>25.00 </h4>
                </div>
                <br>
                <br>
                <br class="">
        ...
        <div class="row d-flex justify-content-center ml-1 mt-3 mr-1">
                                    <button type="button" class="btn btn-light btn-block btn-lg  animate__animated animate__fadeInUp" style="animation-delay: 0.5s" data-toggle="modal" data-target="#SECURING_ONBOARDING_SELECTION"><i class="fe-dollar-sign mr-2"></i>Redeem Card</button>
                                </div>
            <div class="row d-flex justify-content-center mr-1 ml-1 mt-2 mb-4">
                <button type="button" class="btn btn-block btn-translucent-secondary btn-lg animate__animated animate__fadeInUp" style="animation-delay: 0.6s"><i class="fe-share mr-2"></i>Send to Someone</button>
...
<div>
    <p class="text-white text-center mb-0 animate__animated animate__fadeInUp" style="animation-delay: 1.5s">Must be redeemed within 28 days.</p>
    <p class="text-white-50 text-center font-size-sm mt-0  animate__animated animate__fadeInUp" style="animation-delay: 1.7s">Funds must be used within 3 months after redemption. <a>Why?</a></p>
</div>
</div>
</div>
